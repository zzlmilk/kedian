...
-(void)setupNavView{
    ...
    backBtn.frame = CGRectMake(20, 30, 15, 25);
    ...
    UIImageView * albumBtn=[[UIImageView alloc]init];
    albumBtn.frame = CGRectMake(8, self.view.sd_height*0.9 - 100, self.view.sd_width - 16, 100);
    albumBtn.image = [UIImage imageNamed:@"xiangquan"];
