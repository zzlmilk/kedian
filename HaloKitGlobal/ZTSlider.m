...
-(instancetype)initWithFrame:(CGRect)frame titles:(NSArray *)titleArray firstAndLastTitles:(NSArray *)firstAndLastTitles defaultIndex:(CGFloat)defaultIndex sliderImage:(UIImage *)sliderImage
{
    if (self = [super initWithFrame:frame]) {
        ...
        _defaultView = [[UIView alloc] initWithFrame:CGRectMake(CenterImage_W/2, LiuXSliderLine_Y, LiuXSlideWidth-CenterImage_W, 2.0)];
        ...
        _selectView=[[UIView alloc] initWithFrame:CGRectMake(CenterImage_W/2, LiuXSliderLine_Y, LiuXSlideWidth-CenterImage_W, 4)];
...
-(void)setDefaultIndex:(CGFloat)defaultIndex
{
    ...
    CGFloat withPress = defaultIndex / (_titleArray.count - 1);
    //设置默认位置
...
-(void)setFirstAndLastTitles:(NSArray *)firstAndLastTitles
{
    ...
    _leftLab = [[UILabel alloc] initWithFrame:CGRectMake(0, 30, 80, LiuXSliderTitle_H)];
    ...
    _rightLab = [[UILabel alloc] initWithFrame:CGRectMake(LiuXSlideWidth - 80, 30, 80, LiuXSliderTitle_H)];
